...
const INTER_COMMENT = "#a$s%d&f(g)h?j"
...
const commentAsync = code =>
{
    ...
    return currentCode.replace(/\*\s*@__PURE__\s*\*\//, '');
}

const desComment = code => code.replace(/\/\*#a\$s%d&f\(g\)h\?j¡\|#a\$s%d&f\(g\)h\?j¡\*\//g, "");

module.exports = {commentAsync, desComment};